 ...
 */
function plugin_example_pre_show_tab($params) {
 ...
 */
function plugin_example_post_show_tab($params) {
   switch( $params['item']->getType() ) {
      case 'Ticket':
      ...
      case 'Computer':
         echo '<div><span class="red"><strong>Example Plugin:</strong><br/>Some content displayed after tab has been show.</span></div>';
         break;
   }
}
 ...
 */
function plugin_example_pre_show_item($params) {
 ...
 */
function plugin_example_post_show_item($params) {
   if(!is_array($params['item'])) {
      switch( $params['item']->getType() ) {
         case 'Ticket':
            //echo 'test' ;
